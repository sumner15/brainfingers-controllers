...
pt(49).blockname = 'trajectory planning/discrete jerk = 1 minimu jerk = 2';
...
pt(50).blockname = 'trajectory planning/durationBlue';
...
pt(51).blockname = 'trajectory planning/durationBlue1';
...
pt(52).blockname = 'trajectory planning/durationGold';
...
pt(53).blockname = 'trajectory planning/durationGold1';
...
pt(55).blockname = 'trajectory planning/finalPosBlue1';
...
pt(56).blockname = 'trajectory planning/finalPosGold';
...
pt(57).blockname = 'trajectory planning/finalPosGold1';
...
pt(58).blockname = 'trajectory planning/flexOrExtend';
...
pt(59).blockname = 'trajectory planning/hitTimeBlue';
...
pt(60).blockname = 'trajectory planning/hitTimeBlue1';
...
pt(61).blockname = 'trajectory planning/hitTimeGold';
...
pt(62).blockname = 'trajectory planning/hitTimeGold1';
...
pt(63).blockname = 'trajectory planning/Gain1';
...
pt(64).blockname = 'trajectory planning/Gain2';
...
pt(65).blockname = 'trajectory planning/Gain3';
...
pt(66).blockname = 'trajectory planning/Gain4';
...
pt(67).blockname = 'trajectory planning/Gain5';
...
pt(68).blockname = 'Controller/PID/Kd2 gain';
...
pt(69).blockname = 'Controller/PID/Kp2 gain';
...
pt(70).blockname = 'Controller/PID/add position offset';
...
pt(71).blockname = 'Controller/PID/f';
...
pt(72).blockname = 'Controller/PID/kd1 gain';
...
pt(73).blockname = 'Controller/PID/kp1 gain';
...
pt(74).blockname = 'Controller/PID/oscBool1';
...
pt(75).blockname = 'Controller/PID/sigmoid duration in seconds';
...
pt(76).blockname = 'Controller/PID/sigmoid duration in seconds1';
...
pt(77).blockname = 'Controller/PID/Gain';
...
pt(78).blockname = 'Controller/PID/Gain1';
...
pt(79).blockname = 'Controller/PID/Gain2';
...
pt(80).blockname = 'Controller/PID/Gain3';
...
pt(81).blockname = 'Controller/PID/Gain4';
...
pt(82).blockname = 'Controller/PID/Gain5';
...
pt(83).blockname = 'Controller/PID/Gain6';
...
pt(84).blockname = 'Controller/start/Saturation';
pt(84).paramname = 'UpperLimit';
pt(84).class     = 'scalar';
pt(84).nrows     = 1;
pt(84).ncols     = 1;
...
pt(85).blockname = 'Controller/start/Saturation';
pt(85).paramname = 'LowerLimit';
pt(85).class     = 'scalar';
pt(85).nrows     = 1;
pt(85).ncols     = 1;
...
pt(86).blockname = 'Controller/stop/Gain';
...
pt(87).blockname = 'Controller/stop/Gain1';
...
pt(88).blockname = 'Kalman Filter/kalman1/A';
...
pt(89).blockname = 'Kalman Filter/kalman1/B';
...
pt(90).blockname = 'Kalman Filter/kalman1/B1';
...
pt(91).blockname = 'Kalman Filter/kalman1/B2';
...
pt(92).blockname = 'Kalman Filter/kalman1/B3';
...
pt(93).blockname = 'Kalman Filter/kalman1/C';
...
pt(94).blockname = 'Kalman Filter/kalman1/K';
...
pt(95).blockname = 'Kalman Filter/kalman1/Integrator';
...
pt(96).blockname = 'Kalman Filter/kalman2/A';
...
pt(97).blockname = 'Kalman Filter/kalman2/B';
...
pt(98).blockname = 'Kalman Filter/kalman2/B1';
...
pt(99).blockname = 'Kalman Filter/kalman2/B2';
...
pt(100).blockname = 'Kalman Filter/kalman2/B3';
...
pt(101).blockname = 'Kalman Filter/kalman2/C';
...
pt(102).blockname = 'Kalman Filter/kalman2/K';
...
pt(103).blockname = 'Kalman Filter/kalman2/Integrator';
...
pt(104).blockname = 'Kalman Filter/kalman3/A';
...
pt(105).blockname = 'Kalman Filter/kalman3/B';
...
pt(106).blockname = 'Kalman Filter/kalman3/B1';
...
pt(107).blockname = 'Kalman Filter/kalman3/B2';
...
pt(108).blockname = 'Kalman Filter/kalman3/B3';
...
pt(109).blockname = 'Kalman Filter/kalman3/C';
...
pt(110).blockname = 'Kalman Filter/kalman3/K';
...
pt(111).blockname = 'Kalman Filter/kalman3/Integrator';
...
pt(112).blockname = 'Kalman Filter/kalman4/A';
...
pt(113).blockname = 'Kalman Filter/kalman4/B';
...
pt(114).blockname = 'Kalman Filter/kalman4/B1';
...
pt(115).blockname = 'Kalman Filter/kalman4/B2';
...
pt(116).blockname = 'Kalman Filter/kalman4/B3';
...
pt(117).blockname = 'Kalman Filter/kalman4/C';
...
pt(118).blockname = 'Kalman Filter/kalman4/K';
...
pt(119).blockname = 'Kalman Filter/kalman4/Integrator';
...
pt(120).blockname = 'trajectory planning/block commands/block command blue';
...
pt(121).blockname = 'trajectory planning/block commands/block command gold';
...
pt(122).blockname = 'trajectory planning/block commands/block fraction';
...
pt(123).blockname = 'trajectory planning/block commands1/block command blue';
...
pt(124).blockname = 'trajectory planning/block commands1/block command gold';
...
pt(125).blockname = 'trajectory planning/block commands1/block fraction';
...
pt(126).blockname = 'trajectory planning/minimum jerk/added offset 2';
...
pt(127).blockname = 'trajectory planning/minimum jerk/added offset1';
...
pt(128).blockname = 'trajectory planning/minimum jerk/Gain';
...
pt(129).blockname = 'trajectory planning/minimum jerk/tag des pos1';
pt(129).paramname = 'Gain';
pt(129).class     = 'scalar';
pt(129).nrows     = 1;
pt(129).ncols     = 1;
...
pt(130).blockname = 'trajectory planning/minimum jerk/tag des pos2';
...
pt(131).blockname = 'trajectory planning/minimum jerk/Saturation1';
pt(131).paramname = 'UpperLimit';
pt(131).class     = 'scalar';
pt(131).nrows     = 1;
pt(131).ncols     = 1;
...
pt(132).blockname = 'trajectory planning/minimum jerk/Saturation1';
pt(132).paramname = 'LowerLimit';
pt(132).class     = 'scalar';
pt(132).nrows     = 1;
pt(132).ncols     = 1;
...
pt(133).blockname = 'trajectory planning/minimum jerk/Saturation2';
pt(133).paramname = 'UpperLimit';
pt(133).class     = 'scalar';
pt(133).nrows     = 1;
pt(133).ncols     = 1;
...
pt(134).blockname = 'trajectory planning/minimum jerk/Saturation2';
pt(134).paramname = 'LowerLimit';
pt(134).class     = 'scalar';
pt(134).nrows     = 1;
pt(134).ncols     = 1;
...
pt(135).blockname = 'trajectory planning/minimum jerk1/added offset 2';
...
pt(136).blockname = 'trajectory planning/minimum jerk1/added offset1';
...
pt(137).blockname = 'trajectory planning/minimum jerk1/Gain';
...
pt(138).blockname = 'trajectory planning/minimum jerk1/tag des pos1';
...
pt(139).blockname = 'trajectory planning/minimum jerk1/tag des pos2';
...
pt(140).blockname = 'trajectory planning/minimum jerk1/Saturation1';
...
pt(141).blockname = 'trajectory planning/minimum jerk1/Saturation1';
...
pt(142).blockname = 'trajectory planning/minimum jerk1/Saturation2';
...
pt(143).blockname = 'trajectory planning/minimum jerk1/Saturation2';
...
pt(144).blockname = 'Controller/PID/Compare To Constant/Constant';
...
pt(145).blockname = 'Controller/PID/gain transition/Memory';
pt(145).paramname = 'X0';
pt(145).class     = 'vector';
pt(145).nrows     = 1;
pt(145).ncols     = 4;
...
pt(146).blockname = 'Controller/PID/gain transition1/Memory';
pt(146).paramname = 'X0';
pt(146).class     = 'vector';
pt(146).nrows     = 1;
pt(146).ncols     = 4;
...
pt(147).blockname = 'Controller/PID/gain transition2/Memory';
pt(147).paramname = 'X0';
pt(147).class     = 'vector';
pt(147).nrows     = 1;
pt(147).ncols     = 4;
...
pt(148).blockname = 'Controller/PID/gain transition3/Memory';
pt(148).paramname = 'X0';
pt(148).class     = 'vector';
pt(148).nrows     = 1;
pt(148).ncols     = 4;
...
pt(149).blockname = 'Controller/PID/gain transition4/Constant';
...
pt(150).blockname = 'Controller/PID/gain transition4/Memory';
pt(150).paramname = 'X0';
pt(150).class     = 'vector';
pt(150).nrows     = 1;
pt(150).ncols     = 4;
...
pt(151).blockname = 'Controller/PID/gain transition5/Constant';
...
pt(152).blockname = 'Controller/PID/gain transition5/Memory';
pt(152).paramname = 'X0';
pt(152).class     = 'vector';
pt(152).nrows     = 1;
pt(152).ncols     = 4;
...
pt(153).blockname = 'Controller/PID/gain transition6/Constant';
...
pt(154).blockname = 'Controller/PID/gain transition6/Memory';
pt(154).paramname = 'X0';
pt(154).class     = 'vector';
pt(154).nrows     = 1;
pt(154).ncols     = 4;
...
pt(155).blockname = 'Controller/start/Ramp/Constant';
...
pt(156).blockname = 'Controller/start/Ramp/Constant1';
...
pt(157).blockname = 'Controller/start/Ramp/Step';
pt(157).paramname = 'Time';
pt(157).class     = 'scalar';
pt(157).nrows     = 1;
pt(157).ncols     = 1;
...
pt(158).blockname = 'Controller/start/Ramp/Step';
pt(158).paramname = 'Before';
pt(158).class     = 'scalar';
pt(158).nrows     = 1;
pt(158).ncols     = 1;
...
pt(159).blockname = 'Controller/start/Ramp/Step';
pt(159).paramname = 'After';
pt(159).class     = 'scalar';
pt(159).nrows     = 1;
pt(159).ncols     = 1;
...
pt(160).blockname = 'Kalman Filter/kalman3/Discrete Derivative/TSamp';
pt(160).paramname = 'WtEt';
pt(160).class     = 'scalar';
pt(160).nrows     = 1;
pt(160).ncols     = 1;
...
pt(161).blockname = 'Kalman Filter/kalman3/Discrete Derivative/UD';
pt(161).paramname = 'InitialCondition';
pt(161).class     = 'scalar';
pt(161).nrows     = 1;
pt(161).ncols     = 1;
...
pt(162).blockname = 'Kalman Filter/kalman4/Discrete Derivative/TSamp';
pt(162).paramname = 'WtEt';
pt(162).class     = 'scalar';
pt(162).nrows     = 1;
pt(162).ncols     = 1;
...
pt(163).blockname = 'Kalman Filter/kalman4/Discrete Derivative/UD';
